...
namespace RandomVariableStatisticalFunctions
{
    ...
    //***************************************************************************
	    ...
	    double ltqnorm(double p, int errno);   //Inverse cumulatice normal dist function.  Accurate to 10^-9
    ...
    //***************************************************************************
	    ...
	    const double PI_BY_TWO = 1.5707963267949;     		// PI/2
	    ...
	    const double LN_TWO = 0.693147180559945;			// ln(2)
	    const double ROOT_TWO_INVERSE = 0.707106781186545;	// 1/sqrt(2)
	    const double ROOT_THREE = 1.73205080756888;			//	sqrt(3)
	    const double TWO_PI_INVERSE = 0.63661977236758;     // 2/PI
